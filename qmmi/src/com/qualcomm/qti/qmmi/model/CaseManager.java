...
public class CaseManager implements CaseOpCallback, ControllerInterface {
    ...
    private void initCasesAndResult(TestMode type) {
        ...
        if (platformMap.containsKey(platform)) {
			LogUtils.logi( "platformMap platform: " + platform);
            ...
            /**Load case from configure*/
			LogUtils.logi( "platformMap platform: " + platform + "test_case_config & platform_case_config");
    ...
    public int runCase(TestCase testCase) {
        ...
        int ret = mCaseServiceManager.runService(mContext, testCase);
