...
import com.qualcomm.qti.qmmi.testcase.Storage.StorageQueryUtil;
...
public class StorageService extends BaseService {
	...
	/**
     * Get the formatted system total size.
     *
     * @return
     */

	private long getRomTotalData(Context context)
    {
		return StorageQueryUtil.queryWithStorageManager(this);
	}
	
    private String getRomTotalSize(Context context) {
       long size = StorageQueryUtil.queryWithStorageManager(this);
	   return formatData(size);
    }
    ...
    public int run(TestCase testCase) {
        ...
        if(type.equals("sdcard")) {
            ...
            String romTotalSize = getRomTotalSize(this);
            ...
            boolean romTotalState = checkState(testCase, getRomTotalData(this));
